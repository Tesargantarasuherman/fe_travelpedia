        ...
        <div className="container-content-featured-tours">
          <div className="container-card-tours">
            ...
            <div className="content-card-tours">
              ...
              <div className="available-ticket-card-tours">
                <p>Available Today</p>
                <div className='ticket-available-ticket-card-tours'>
                  <img src={TicketIcon} className="icon-available-ticket-card-tours" alt="" srcset="" />
                  <p>300 Sold</p>
                </div>
              </div>
            </div>
